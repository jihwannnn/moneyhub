...
class BoardFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        val postList = listOf(
            BoardItem(1, "Post Title 1", "This is the first post.", LocalDateTime.now().minusMinutes(1), 5, "https://example.com/image1.jpg"),
            ...
            BoardItem(5, "교양 취업계", "막학기 14학점 남았는데 전공학점은 다 채웠고 교양만 들으면 되는데 취업계가 가능한가요? 교양 교수님들도 취업계 인정 해주시나요", LocalDateTime.now().minusDays(11), 5, "https://example.com/image1.jpg"),
            BoardItem(6, "선배님들 차 사는거 어케 생각하심??", "아부지 차로 연습을 하는중인데 차 한데 사려고 함\n업무 특성상 여기저기 돌아다녀야 해서 하나 사려는데\n첫차로 새차를 살까요 아니면 굴러가는 중고 사서 연습을 할까요?", LocalDateTime.now().minusDays(23), 3, null), // 이미지 없음
            BoardItem(7, "멘토링", "저희 학교 현장실습지원센터에서 지원해주는 멘토링 활동 있나요?", LocalDateTime.now().minusDays(56), 10, "https://example.com/image2.jpg"),
            BoardItem(8, "동기들은 다 잘나가는데", "왜 나만..?", LocalDateTime.now().minusDays(80), 0, null) // 이미지 없음,
        )
